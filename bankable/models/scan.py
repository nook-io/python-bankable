...
class SCAN(BaseModel):
    ...
    SCAN
    """ # noqa: E501
    sort_code: Optional[Any] = Field(description="The 6 digit sort code that identifies the Client bank.")
    account_number: Optional[Any] = Field(description="Client bank account number.")
    __properties: ClassVar[List[str]] = ["sort_code", "account_number"]
