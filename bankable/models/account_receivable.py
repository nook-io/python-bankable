...
class AccountReceivable(BaseModel):
    ...
    debtor_id: Optional[Any] = Field(description="Any information that could identify unique debtors per transaction.")
    face_value: Optional[Any] = Field(description="The value of the transaction.")
    __properties: ClassVar[List[str]] = ["invoice_id", "due_date", "settled_date", "debtor_id", "face_value"]
