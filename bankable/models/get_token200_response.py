...
class GetToken200Response(BaseModel):
    ...
    GetToken200Response
    """ # noqa: E501
    access_token: Optional[StrictStr] = Field(default=None, description="Authentication token.")
    token_type: Optional[StrictStr] = Field(default=None, description="The type of the authentication token.")
    expires_in: Optional[StrictInt] = Field(default=None, description="The lifetime (in seconds) of the token.")
