...
class CancelCredit200Response(BaseModel):
    """
    CancelCredit200Response
    """ # noqa: E501
    credit_id: Optional[Any] = Field(default=None, description="The Credit ID provided by Bankable.")
    state: Optional[Any] = Field(default=None, description="The state of the Credit after cancellation.")
    __properties: ClassVar[List[str]] = ["credit_id", "state"]
