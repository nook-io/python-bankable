...
class FindClient200ResponsePagination(BaseModel):
    """
    FindClient200ResponsePagination
    """ # noqa: E501
    limit: Optional[Any] = Field(default=None, description="The number of items in the response. The limit/offset schema is used for pagination.")
