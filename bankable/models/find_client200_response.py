...
class FindClient200Response(BaseModel):
    """
    FindClient200Response
    """ # noqa: E501
    results: Optional[Any] = Field(default=None, description="Paginated list of clients.")
    pagination: Optional[FindClient200ResponsePagination] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": FindClient200ResponsePagination.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None
        })
        return _obj
