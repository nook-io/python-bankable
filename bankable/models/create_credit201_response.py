...
class CreateCredit201Response(BaseModel):
    """
    CreateCredit201Response
    """ # noqa: E501
    id: Optional[Any] = Field(default=None, description="Please, persist the Bankable Credit ID to get further updates and details about the credit.")
