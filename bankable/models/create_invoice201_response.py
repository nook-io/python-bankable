...
class CreateInvoice201Response(BaseModel):
    """
    CreateInvoice201Response
    """ # noqa: E501
    invoice_id: Optional[Any] = Field(default=None, description="Please persist the Bankable invoice ID to get further updates and details about the invoice.")
    __properties: ClassVar[List[str]] = ["invoice_id"]
