...
class TestCreateCredit201Response(unittest.TestCase):
    """CreateCredit201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCredit201Response:
        """Test CreateCredit201Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCredit201Response`
        """
        model = CreateCredit201Response()
        if include_optional:
            return CreateCredit201Response(
                id = b1392c00-c553-4a9f-96db-098aa83471d1
            )
        else:
            return CreateCredit201Response(
        )
    ...
    def testCreateCredit201Response(self):
        """Test CreateCredit201Response"""
