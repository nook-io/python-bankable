...
class TestSubmitBankData400Response(unittest.TestCase):
    """SubmitBankData400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitBankData400Response:
        """Test SubmitBankData400Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmitBankData400Response`
        """
        model = SubmitBankData400Response()
        if include_optional:
            return SubmitBankData400Response(
            )
        else:
            return SubmitBankData400Response(
        )
    ...
    def testSubmitBankData400Response(self):
        """Test SubmitBankData400Response"""
