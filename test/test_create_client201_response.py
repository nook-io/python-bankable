...
class TestCreateClient201Response(unittest.TestCase):
    """CreateClient201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateClient201Response:
        """Test CreateClient201Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateClient201Response`
        """
        model = CreateClient201Response()
        if include_optional:
            return CreateClient201Response(
                client_id = 'cbbd0a65-a149-436a-99bd-06e819a44da9'
            )
        else:
            return CreateClient201Response(
        )
    ...
    def testCreateClient201Response(self):
        """Test CreateClient201Response"""
