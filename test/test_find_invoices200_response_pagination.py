...
class TestFindInvoices200ResponsePagination(unittest.TestCase):
    """FindInvoices200ResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FindInvoices200ResponsePagination:
        """Test FindInvoices200ResponsePagination
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FindInvoices200ResponsePagination`
        """
        model = FindInvoices200ResponsePagination()
        if include_optional:
            return FindInvoices200ResponsePagination(
                limit = 20,
                offset = 10,
                total_items = 2033
            )
    ...
    def testFindInvoices200ResponsePagination(self):
        """Test FindInvoices200ResponsePagination"""
