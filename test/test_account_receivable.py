...
class TestAccountReceivable(unittest.TestCase):
    """AccountReceivable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountReceivable:
        """Test AccountReceivable
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountReceivable`
        """
        ...
        if include_optional:
            return AccountReceivable(
                ...
                debtor_id = 196af880-ab2b-4418-af40-95bb7ed78977,
                face_value = 900.25
            )
        else:
            return AccountReceivable(
    ...
    def testAccountReceivable(self):
        """Test AccountReceivable"""
