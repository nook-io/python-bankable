...
class TestGetCreditPriceBreakdown200Response(unittest.TestCase):
    """GetCreditPriceBreakdown200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCreditPriceBreakdown200Response:
        """Test GetCreditPriceBreakdown200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCreditPriceBreakdown200Response`
        """
        model = GetCreditPriceBreakdown200Response()
        if include_optional:
            return GetCreditPriceBreakdown200Response(
                evaluation_ok = true,
                expiration_date = 2022-12-24,
                score = 77,
                min_annual_percentage_rate = 4.78%,
                max_annual_percentage_rate = 9.13%,
                matrix = None
            )
        else:
            return GetCreditPriceBreakdown200Response(
    ...
    def testGetCreditPriceBreakdown200Response(self):
        """Test GetCreditPriceBreakdown200Response"""
