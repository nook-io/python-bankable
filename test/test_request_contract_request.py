...
class TestRequestContractRequest(unittest.TestCase):
    """RequestContractRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestContractRequest:
        """Test RequestContractRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestContractRequest`
        """
        model = RequestContractRequest()
        if include_optional:
            return RequestContractRequest(
                signers = None
            )
        else:
            return RequestContractRequest(
    ...
    def testRequestContractRequest(self):
        """Test RequestContractRequest"""
